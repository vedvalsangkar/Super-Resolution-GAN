# -*- coding: utf-8 -*-
"""
Created on Sat May 11 21:01:56 2019
...
train_files = load_data("./data_shubhra/DIV_Flickr/train/train_HR", ".png")
val_files = load_data("./data_shubhra/DIV_Flickr/val/val_HR", ".png")
x_train = train_files
x_test = val_files
...
def normalize(input_data):
    ...
    return (input_data.astype(float) - 127.5)/127.5 
...
x_train_lr = hr_images(load_data("./data_shubhra/DIV_Flickr/train/train_LR", ".png"))
...
x_test_lr = hr_images(load_data("./data_shubhra/DIV_Flickr/val/val_LR", ".png"))
